...
const ImageList = [
  {
    ...
    description: 
      `Lorem His Life will forever be changed dolor, sit amet, consectetur adipiscing ElementInternals, sed do
        eisumod tempor incididunt ut labore et dolore magna aliqua.`
  },
  {
    id: 2,
    img: Image2,
...
const Hero = () => {
  ...
  return (
    ...
    >
      {/* bckground pattern */}
      <div 
        className='h-[700px] w-[700px] bg-primary/40 absolute  -top-1/2 right-0 rounded-3xl rotate-45 -z[8]'>
        </div>
       {/* hero section */}
       <div
        ...
        <Slider {...settings}>
          {ImageList.map((data)=>(
             ...
             <div className='grid grid-cols-1 sm:grid-cols-2'>
               ...
               <div 
                 className='flex flex-col justify-self-center gap-4 pt-12 sm:pt-0 text-center sm:text-left
                       order-2 sm:order-1 relative z-10 ' 
               >
                 <h1 className='text-5xl sm:text-6xl lg:trext-7xl font-bold'>
                  {data.title}
                  </h1>
                 <p className='text-sm'>
                  {data.description}
